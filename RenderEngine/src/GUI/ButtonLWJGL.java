...
public class ButtonLWJGL {

    public interface Behaviour {
        void executeBehaviour(ButtonLWJGL b, Vector mousePos, boolean isPressed);
    }
...
//    }
    ...
    public ButtonLWJGL(GameLWJGL game, Vector position, double width, double height) {
