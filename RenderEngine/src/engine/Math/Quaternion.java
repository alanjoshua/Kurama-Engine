...
//
//		float yaw = (float) engine.Math.toDegrees(engine.Math.atan2(2 * y * w - 2 * x * z, 1 - 2 * y * y - 2 * z * z));
//		float pitch = (float) engine.Math.toDegrees(engine.Math.atan2(2 * x * w - 2 * y * z, 1 - 2 * x * x - 2 * z * z));
//		float roll = (float) engine.Math.toDegrees(engine.Math.asin(2 * x * y + 2 * z * w));
//
//		return new Vector(new float[] { pitch, yaw, roll });
//	}
//
//	public float getNorm() {
////		float res = 0;
////		res += engine.Math.pow(coordinate.getDataElement(0),2);
////		res += engine.Math.pow(coordinate.getDataElement(1),2);
////		res += engine.Math.pow(coordinate.getDataElement(2),2);
////		res += engine.Math.pow(coordinate.getDataElement(3),2);
//
...
//		float angle = (float) (2 * engine.Math.acos(this.coordinate.getDataElement(0)));
//		this.angle = (float) engine.Math.toDegrees(angle);
//
//		if (this.angle != 0) {
//
//			float temp = (float) engine.Math.sqrt(1 - (coordinate.getDataElement(0) * coordinate.getDataElement(0)));
...
//		float a = (float) engine.Math.toRadians(angle / 2f);
//		float[] data = new float[] { (float) engine.Math.cos(a), (float) (engine.Math.sin(a) * axis.getDataElement(0)),
//				(float) (engine.Math.sin(a) * axis.getDataElement(1)), (float) (engine.Math.sin(a) * axis.getDataElement(2)) };
