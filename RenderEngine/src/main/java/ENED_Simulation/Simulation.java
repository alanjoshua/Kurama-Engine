...
//    protected Camera cam;
    ...
    protected List<ENED_Simulation.Box> boxesToBeSearched;
    protected List<ENED_Simulation.Box> boxesAlreadySearched;
    protected List<ENED_Simulation.Box> boxesAtDestination;
    Scanner scanner;
    ...
    protected List<Button> pauseButtons;
...
//        h1.shouldUseMaterial = false;
    ...
    public void addBoxToSearched(ENED_Simulation.Box box) {
        boxesToBeSearched.remove(box);
        boxesAlreadySearched.add(box);
    }

    public void addBoxToAtDestination(ENED_Simulation.Box box) {
