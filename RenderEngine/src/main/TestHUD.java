...
public class TestHUD extends HUD {
    ...
    public TestHUD(Game game) {
        ...
        Model texquad = game.scene.createModel(game.scene.loadMesh("res/misc/quad.obj", "HUD_texquad_mesh", null), "texQuad", ((RenderingEngineGL)game.getRenderingEngine()).hudShaderID);
        ...
        game.scene.addModel(demoText, ((RenderingEngineGL)game.getRenderingEngine()).hudShaderID);
