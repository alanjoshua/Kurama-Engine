...
import Kurama.ComponentSystem.automations.InputHandling;
...
public class MindPalaceMainInputHandling extends InputHandling {

    public MindPalace game;

    public MindPalaceMainInputHandling(MindPalace game) {this.game = game;}
